...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "8 min",
    keywords: [
      "noorpath academy vision", "noorpath academy review", "online quran academy mission",
      "noorpath online quran learning", "modern islamic education online", "noorpath academy tutors",
      "safe quran learning for kids", "quran education technology", "parent portal quran progress",
    ],
    excerpt:
      "NoorPath Academy is redefining online Quran learning with a People-First approach, certified tutors, and dedicated tools like the Parent Portal. Discover our mission to provide authentic, safe, and effective education to Muslim families worldwide.",
    author: AUTHOR, authorTitle: AUTHOR_TITLE, authorSlug: AUTHOR_SLUG,
    coverImage: "/marketing/noorpath-vision.jpg",
  },
  {
