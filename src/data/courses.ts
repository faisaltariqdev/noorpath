...
export const courses: Course[] = [
  ...
  },
  {
    ...
    duration: "Learner-paced",
    sessionsPerWeek: "Choose 1–4 sessions/week",
    keywords: ["tajweed classes online", "learn tajweed online", "tajweed rules online", "quran tajweed course", "tajweed for beginners", "online tajweed classes for children", "tajweed classes for kids"],
    faqs: [
      ...
      { q: "Are online Tajweed classes for children available?", a: "Yes. Children who can already read Arabic letters may request Tajweed-focused lessons with age-aware pacing. Younger beginners usually start with Noorani Qaida first; the free trial helps confirm readiness." },
  ...
  },
  {
    ...
    duration: "Ongoing",
    sessionsPerWeek: "Choose 1–4 sessions/week",
    keywords: ["islamic studies online", "online islamic education", "learn islam online", "islamic classes online", "online islamic classes for children", "fiqh aqeedah online"],
    faqs: [
      ...
      { q: "Are online Islamic classes for children the same as Quran reading classes?", a: "Not exactly. Online Islamic classes for children usually cover faith basics, manners, Seerah and practical worship understanding. Quran reading and Tajweed are separate tracks that many families combine with Islamic studies." },
