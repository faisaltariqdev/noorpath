...
export const courses: Course[] = [
  {
    ...
    desc: "A structured first step for Quran beginners — learn Arabic letters, pronunciation, and reading foundations before moving to Quran recitation.",
    fullDesc: "Noorani Qaida provides a structured foundation for students beginning their Quran learning journey. Lessons cover Arabic letters, vowel signs (Harakat), Tanwin, Sukoon, Madd, pronunciation points (Makharij), and other foundational reading rules.",
