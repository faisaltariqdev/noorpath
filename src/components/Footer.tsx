...
const courses = [
  ...
  { href: "/quran-classes-near-me", label: "Quran Classes Near Me (Online)" },
  { href: "/online-quran-classes-no-masjid-nearby", label: "No Masjid Nearby?" },
  { href: "/learn-quran-as-a-revert", label: "Quran for Reverts & New Muslims" },
