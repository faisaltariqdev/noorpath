...
import { studyingQuranOnline } from "@/lib/landingPageData";

export const revalidate = false;

const PATH = "/studying-quran-online";
const { metaTitle, metaDescription, keywords, ...props } = studyingQuranOnline;
...
export default function StudyingQuranOnlinePage() {
