        ...
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Female tutor requests for this country (Fix 11D) */}
              <div className="content-card" style={{ marginBottom: 28, borderTop: "3px solid var(--emerald)" }}>
                <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "1.3rem", color: "var(--charcoal)", marginBottom: 12 }}>
                  Female Quran Teacher for {loc.country} Families
                </h2>
                <p style={{ color: "var(--muted)", lineHeight: 1.8, fontSize: ".95rem", marginBottom: 14 }}>
                  Sisters and daughters in {loc.country} can request a <strong>female Quran teacher online</strong> for private 1-to-1 lessons.
                  Subject fit, relevant credentials, and {loc.timezone} schedule availability are confirmed after your request — NoorPath does not claim a physical branch in every city listed on this page.
                </p>
                <ul style={{ listStyle: "none", padding: 0, margin: "0 0 16px", display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    "Female tutor preference recorded at booking",
                    "Kids and adult sister pathways",
                    "Evening or weekend windows considered when available",
                  ].map((item) => (
                    <li key={item} style={{ display: "flex", gap: 8, alignItems: "flex-start", fontSize: ".88rem", color: "var(--slate)" }}>
                      <CheckCircle size={15} style={{ color: "var(--emerald)", marginTop: 2, flexShrink: 0 }} /> {item}
                    </li>
                  ))}
                </ul>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
                  <Link href="/quran-classes-for-sisters" style={{ color: "var(--emerald)", fontWeight: 700, fontSize: ".88rem" }}>
                    → Quran classes for sisters
                  </Link>
                  <Link href="/female-quran-teacher-online" style={{ color: "var(--emerald)", fontWeight: 700, fontSize: ".88rem" }}>
                    → Female Quran teacher hub
                  </Link>
                  <Link href="#trial" style={{ color: "var(--emerald)", fontWeight: 700, fontSize: ".88rem" }}>
                    → Book free trial
                  </Link>
                </div>
              </div>
