...
import { quranClassesNearMe } from "@/lib/landingPageData";
import { BASE_URL } from "@/lib/academyFacts";

export const revalidate = false;

const PATH = "/quran-classes-near-me";
const { metaTitle, metaDescription, keywords, ...props } = quranClassesNearMe;
...
export default function QuranClassesNearMePage() {
