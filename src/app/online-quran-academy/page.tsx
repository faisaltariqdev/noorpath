...
import { onlineQuranAcademy } from "@/lib/landingPageData";

const PATH = "/online-quran-academy";
const { metaTitle, metaDescription, keywords, ...props } = onlineQuranAcademy;
...
export default function OnlineQuranAcademyPage() {
