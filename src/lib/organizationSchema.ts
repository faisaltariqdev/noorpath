    ...
    "@graph": [
      {
        ...
        hasOfferCatalog: {
          ...
          itemListElement: [
            { "@type": "Offer", itemOffered: { "@type": "Course", name: "Learn Quran Online", url: `${BASE_URL}/learn-quran-online` } },
            { "@type": "Offer", itemOffered: { "@type": "Course", name: "Noorani Qaida Online", url: `${BASE_URL}/learn-quran-online` } },
            { "@type": "Offer", itemOffered: { "@type": "Course", name: "Tajweed Classes Online", url: `${BASE_URL}/learn-tajweed-online` } },
            { "@type": "Offer", itemOffered: { "@type": "Course", name: "Hifz Program Online", url: `${BASE_URL}/hifz-quran-online` } },
            { "@type": "Offer", itemOffered: { "@type": "Course", name: "Quran Classes for Kids", url: `${BASE_URL}/online-quran-classes-for-kids` } },
