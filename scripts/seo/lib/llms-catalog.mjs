...
export const TOPIC_INTENTS = [
  ...
  },
  {
    ...
    supporting: [
      ...
      "/blog/after-school-quran-classes-for-gulf-families",
      "/blog/quran-classes-for-expat-families",
      "/free-quran-classes-online",
    ],
  },
  {
    topic: "Singapore & Malaysia online Quran classes (SGT / MYT)",
    summary:
      "Singapore and Malaysia hubs for live one-to-one online Quran classes with SGT/MYT evening windows, adult beginner honesty, and school routine planning.",
    primary: [
      "/locations/online-quran-classes-singapore",
      "/locations/online-quran-classes-malaysia",
    ],
    supporting: [
  ...
  {
    topic: "South Asia online Quran classes (India & Pakistan - IST / PKT)",
    summary:
      "India and Pakistan hubs for live one-to-one online Quran classes with IST/PKT after-school planning, Hyderabad and Mumbai guides, and school-balance support.",
    primary: [
      "/locations/online-quran-classes-india",
      "/locations/online-quran-classes-pakistan",
    ],
    supporting: [
      "/online-quran-classes/hyderabad",
      "/online-quran-classes/mumbai",
      "/blog/after-school-quran-classes-for-kids-in-india",
      "/blog/balancing-school-and-online-quran-in-pakistan",
      "/noorani-qaida",
      "/female-quran-teacher-online",
      "/free-quran-classes-online",
    ],
...
export const PRIORITY_COUNTRIES = [
  ...
  { path: "/locations/online-quran-classes-malaysia", label: "Malaysia", note: "Malaysia MYT scheduling context for online Quran classes (online only)." },
  ...
  { path: "/locations/online-quran-classes-pakistan", label: "Pakistan", note: "Pakistan PKT scheduling context for online Quran classes (online only)." },
...
export const BLOG_CLUSTERS = [
  {
    ...
    items: [
      ...
      { slug: "after-school-quran-classes-for-kids-in-india", label: "India after-school online Quran classes for kids" },
      { slug: "balancing-school-and-online-quran-in-pakistan", label: "Balancing school and online Quran in Pakistan" },
      { slug: "after-school-quran-classes-for-gulf-families", label: "After-school online Quran classes for Gulf families" },
      { slug: "timezone-friendly-quran-classes-uk-europe", label: "Timezone-friendly Quran classes UK & Europe" },
      { slug: "muslim-families-europe-balance-school-quran", label: "Muslim families in Europe balancing school and Quran" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "dua-e-masura-arabic-english", label: "Dua e Masura" },
      { slug: "jazakallah-khair-meaning", label: "Jazakallah Khair meaning" },
      { slug: "barakallah-meaning", label: "Barakallah meaning" },
      { slug: "dua-for-success-exams", label: "Dua for success and exams" },
      { slug: "dua-for-marriage", label: "Dua for marriage" },
      ...
      { slug: "dua-entering-leaving-home", label: "Dua for entering and leaving home" },
      { slug: "how-to-do-ghusl-step-by-step", label: "How to do Ghusl step by step" },
      { slug: "how-to-pray-witr", label: "How to pray Witr" },
      { slug: "allahu-akbar-meaning-in-english", label: "Allahu Akbar meaning in English" },
      { slug: "la-ilaha-illallah-meaning", label: "La ilaha illallah meaning" },
      { slug: "dua-before-sleeping-islam", label: "Dua before sleeping" },
      { slug: "evil-eye-dua-nazar-ruqyah", label: "Evil eye (Nazar) dua & Ruqyah" },
      { slug: "morning-evening-adhkar-dhikr", label: "Morning and evening Adhkar" },
      { slug: "last-two-ayahs-surah-baqarah", label: "Last two Ayahs of Surah Baqarah" },
      { slug: "dua-for-parents-rabbirhamhuma", label: "Dua for parents (Rabbirhamhuma)" },
      { slug: "surah-ikhlas-benefits", label: "Surah Ikhlas benefits & translation" },
      { slug: "ayatul-kursi-arabic-english-benefits", label: "Ayatul Kursi Arabic, English & benefits" },
      { slug: "alhamdulillah-meaning-in-english", label: "Alhamdulillah meaning in English" },
      { slug: "subhanallah-meaning", label: "Subhanallah meaning" },
      { slug: "mashallah-meaning", label: "Mashallah meaning" },
      { slug: "inshallah-meaning-in-english", label: "Inshallah meaning in English" },
      { slug: "bismillah-meaning-in-english", label: "Bismillah meaning in English" },
      { slug: "surah-yaseen-arabic-english", label: "Surah Yaseen Arabic & English" },
      { slug: "surah-mulk-benefits", label: "Surah Mulk benefits" },
      { slug: "dua-e-istikhara", label: "Dua e Istikhara step by step" },
      { slug: "4-quls", label: "4 Quls full Arabic & English" },
      { slug: "sajdah-tilawat-dua-arabic-english", label: "Sajdah Tilawat dua" },
      { slug: "inna-lillahi-wa-inna-ilayhi-rajiun-meaning", label: "Inna lillahi wa inna ilayhi raji'un meaning" },
      { slug: "dua-before-and-after-eating", label: "Dua before and after eating" },
    ],
  },
  {
